...
(function() {
  ...
  function initSidebar() {
    ...
    function restoreCollapsedState() {
      ...
      // Remove the no-transition helper class after state is applied
      // Use requestAnimationFrame to ensure the collapsed class is rendered first
  ...
  function initSidebarResize() {
    ...
    function restoreWidth() {
      ...
      // Remove the preload style injected in <head> now that JS has taken over
      const preloadStyle = document.getElementById('sidebar-width-preload');
    ...
    function onMouseMove(e) {
      ...
      setWidth(newWidth);
      // Notify components (e.g. scroll progress bar) of sidebar width change
      window.dispatchEvent(new CustomEvent('sidebar-toggle'));
    }
