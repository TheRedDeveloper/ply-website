...
*This summary is not legal advice. Read the full text below for the legally binding terms.*

A source-available license that permits non-commercial use, modification, and deployment of independent environments while strictly defending the commercial and operational integrity of the official software.

| Permissions | Limitations | Conditions |
| --- | --- | --- |
| **✓ Noncommercial Use:** You can use the software for any non-profit, educational, or hobby purpose. | **✕ Commercial Use:** You cannot sell the software, use it to make money, or charge fees. | **⚠ License and Copyright Notice:** You must include the original license text and copyright notices in all copies. |
| **✓ Modification:** You can change the code, alter features, or adapt the software for your own needs. | **✕ Commercial Interference:** You cannot directly interfere with, circumvent, or degrade the licensor's commercial exploitation of the software, such as removing ads. | **⚠ Contribution Grant:** Any changes, patches, or new works intentionally submitted to the licensor grant them commercial rights. |
| **✓ Distribution:** You can share your modified software or code with others non-commercially. | **✕ Evasion:** You cannot modify the software to circumvent suspensions, bans, or access restrictions. |  |
| **✓ Independent Environments:** You are free to run custom servers, endpoints, or clients. | **✕ Unofficial Moderation:** The licensor is not responsible for or evaluated by conduct, content, or moderation in independent environments. |  |
|  | **✕ Liability & Warranty:** The software comes as-is, without any warranty, condition, or liability for damages. |  |
